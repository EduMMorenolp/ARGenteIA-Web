...
const steps = [
    ...
    },
    {
        ...
        number: '02',
        title: 'Instalar',
        description: 'Hacé doble click en instalar.bat. Se instala todo automáticamente: Node.js, dependencias y configuración.',
        color: '#10b981',
    ...
    },
    {
        ...
        number: '03',
        title: 'Configurar',
        description: 'Editá config.json y agregá tu API key. Podés obtener una gratis en OpenRouter o usar modelos locales con Ollama.',
        color: '#a855f7',
    ...
    },
    {
        ...
        number: '04',
        title: 'Iniciar',
        description: 'Doble click en ARGenteIA.bat. Se abre el panel de control donde podés iniciar y detener el servidor.',
        color: '#f97316',
